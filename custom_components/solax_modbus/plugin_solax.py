...
MAX_EXPORT: list[tuple[str, int | float]] = [
    ...
    ("H3BG15", 15000),  # Gen5 X3 Ultra G
    ("H3BG19", 19999),  # Gen5 X3 Ultra G
...
NUMBER_TYPES: Sequence["SolaxModbusNumberEntityDescription"] = [
    ...
    SolaxModbusNumberEntityDescription(
        ...
        device_class=NumberDeviceClass.POWER,
        initvalue=0,
        register_data_type=REGISTER_S32,  # positive discharge; negative charge
        write_method=WRITE_DATA_LOCAL,
        fmt="i",
        suggested_display_precision=0,
    ),
    ...
    SolaxModbusNumberEntityDescription(
        name="Threshold Off Consumption",
        key="consume_off_power",
        register=0xB9,
        device_group="dry_contact",
        active_when={"dry_contact_mode": ("Load Management",), "work_mode": ("Smart Save",)},
        fmt="i",
        native_min_value=0,
    ...
    SolaxModbusNumberEntityDescription(
        name="Threshold On Feed-in Power",
        key="feedin_on_power",
        register=0xB7,
        device_group="dry_contact",
        active_when={"dry_contact_mode": ("Load Management",), "work_mode": ("Smart Save",)},
    ...
    SolaxModbusNumberEntityDescription(
        name="Threshold Off Battery SoC",
        key="switch_off_soc",
        register=0xBA,
        device_group="dry_contact",
        active_when={"dry_contact_mode": ("Load Management",), "work_mode": ("Smart Save",)},
    ...
    #####
    #
    # (Modbus) Power control direct
    # https://kb.solaxpower.com/solution/detail/2c9fa4148ecd09eb018edf67a87b01d2
    # registers A0-A7 only tested on Gen4 with Firmware: DSP v1.50 ARM v1.47
    #
    #####
    SolaxModbusNumberEntityDescription(
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Upper 1",
        key="grid_voltage_upper_1",
        device_group="settings",
        register=0x60B,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Upper 2",
        key="grid_voltage_upper_2",
        device_group="settings",
        register=0x604,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Upper 3",
        key="grid_voltage_upper_3",
        device_group="settings",
        register=0x670,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Lower 1",
        key="grid_voltage_lower_1",
        device_group="settings",
        register=0x60A,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Lower 2",
        key="grid_voltage_lower_2",
        device_group="settings",
        register=0x603,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Lower 3",
        key="grid_voltage_lower_3",
        device_group="settings",
        register=0x671,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage 10 min Average",
        key="grid_voltage_10min_average",
        device_group="settings",
        register=0x609,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Upper 1 Time",
        key="grid_voltage_upper_1_time",
        device_group="settings",
        register=0x643,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Upper 2 Time",
        key="grid_voltage_upper_2_time",
        device_group="settings",
        register=0x646,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Lower 1 Time",
        key="grid_voltage_lower_1_time",
        device_group="settings",
        register=0x642,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Voltage Lower 2 Time",
        key="grid_voltage_lower_2_time",
        device_group="settings",
        register=0x647,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Frequency Upper 1",
        key="grid_frequency_upper_1",
        device_group="settings",
        register=0x60D,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Frequency Upper 2",
        key="grid_frequency_upper_2",
        device_group="settings",
        register=0x606,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Frequency Lower 1",
        key="grid_frequency_lower_1",
        device_group="settings",
        register=0x60C,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Frequency Lower 2",
        key="grid_frequency_lower_2",
        device_group="settings",
        register=0x605,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Frequency Upper 1 Time",
        key="grid_frequency_upper_1_time",
        device_group="settings",
        register=0x645,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Frequency Upper 2 Time",
        key="grid_frequency_upper_2_time",
        device_group="settings",
        register=0x648,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Frequency Lower 1 Time",
        key="grid_frequency_lower_1_time",
        device_group="settings",
        register=0x644,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Grid Frequency Lower 2 Time",
        key="grid_frequency_lower_2_time",
        device_group="settings",
        register=0x649,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Soft Start Slope",
        key="soft_start_slope",
        device_group="settings",
        register=0x652,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Reconnection Gradient",
        key="reconnection_gradient",
        device_group="settings",
        register=0x653,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Over Frequency Point",
        key="over_frequency_point",
        device_group="settings",
        register=0x621,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Over Frequency Ramp",
        key="over_frequency_ramp",
        device_group="settings",
        register=0x622,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Over Frequency Recover Point",
        key="over_frequency_recover_point",
        device_group="settings",
        register=0x64A,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Over Frequency Droop Rate",
        key="over_frequency_droop_rate",
        device_group="settings",
        register=0x64B,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Over Frequency Exit Delay",
        key="over_frequency_exit_delay",
        device_group="settings",
        register=0x64C,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Over Frequency Max Point",
        key="over_frequency_max_point",
        device_group="settings",
        register=0x64D,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Under Frequency Point",
        key="under_frequency_point",
        device_group="settings",
        register=0x624,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Under Frequency Ramp",
        key="under_frequency_ramp",
        device_group="settings",
        register=0x625,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Under Frequency Recover Point",
        key="under_frequency_recover_point",
        device_group="settings",
        register=0x64E,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Under Frequency Droop Rate",
        key="under_frequency_droop_rate",
        device_group="settings",
        register=0x64F,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Under Frequency Exit Delay",
        key="under_frequency_exit_delay",
        device_group="settings",
        register=0x650,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Under Frequency Min Point",
        key="under_frequency_min_point",
        device_group="settings",
        register=0x651,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Cos Phi Pf1 Limit Up",
        key="cos_phi_pf1_limit_up",
        device_group="settings",
        register=0x628,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Cos Phi Pf2 Limit Down",
        key="cos_phi_pf2_limit_down",
        device_group="settings",
        register=0x629,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Cos Phi Pf3 Limit Up",
        key="cos_phi_pf3_limit_up",
        device_group="settings",
        register=0x62A,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Cos Phi Pf4 Limit Down",
        key="cos_phi_pf4_limit_down",
        device_group="settings",
        register=0x62B,
        fmt="f",
        scale=0.01,
    ...
    SolaxModbusNumberEntityDescription(
        name="Cos Phi Power Ratio 1",
        key="cos_phi_power_ratio_1",
        device_group="settings",
        register=0x62C,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Cos Phi Power Ratio 2",
        key="cos_phi_power_ratio_2",
        device_group="settings",
        register=0x62D,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Cos Phi Power Ratio 3",
        key="cos_phi_power_ratio_3",
        device_group="settings",
        register=0x62E,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Cos Phi Power Ratio 4",
        key="cos_phi_power_ratio_4",
        device_group="settings",
        register=0x62F,
        fmt="f",
        scale=0.1,
    ...
    SolaxModbusNumberEntityDescription(
        name="Export Power Limit Hard",
        key="export_power_limit_hard",
        device_group="settings",
        register=0x65D,
        fmt="i",
        native_min_value=0,
    ...
    SolaxModbusNumberEntityDescription(
        name="General Control Value",
        key="general_control_value",
        device_group="settings",
        register=0x65E,
        fmt="i",
        native_min_value=0,
    ...
    SolaxModbusNumberEntityDescription(
        name="General Control Value Hard",
        key="general_control_value_hard",
        device_group="settings",
        register=0x65F,
        fmt="i",
        native_min_value=0,
...
SWITCH_TYPES: Sequence["SolaXModbusSwitchEntityDescription"] = [
    SolaXModbusSwitchEntityDescription(
        name="Export Control Enable",
        key="export_control_enable",
        device_group="settings",
        register=0x65B,
        sensor_key="export_control_enable",
    ...
    SolaXModbusSwitchEntityDescription(
        ...
        key="parallel_enable_mic",
        device_group="settings",
        register=0x665,
        sensor_key="parallel_enable_mic",
        value_function=value_function_enable_disable,
        entity_category=EntityCategory.CONFIG,
        allowedtypes=MIC | GEN2 | X3,
    ...
    SolaXModbusSwitchEntityDescription(
        name="Q(u) Lock Enable",
        key="qu_lock_enable",
        device_group="settings",
        register=0x654,
        sensor_key="qu_lock_enable",
        value_function=value_function_enable_disable,
        entity_category=EntityCategory.CONFIG,
        allowedtypes=MIC | GEN2 | X3,
        icon="mdi:lock",
    ...
    SolaXModbusSwitchEntityDescription(
        name="External Failed",
        key="external_failed",
        device_group="settings",
        register=0x663,
        sensor_key="external_failed",
        value_function=value_function_enable_disable,
        entity_category=EntityCategory.CONFIG,
        allowedtypes=MIC | GEN2 | X3,
    ...
    SolaXModbusSwitchEntityDescription(
        ...
        register=0xA6,
        sensor_key="discharge_cut_off_point_different",
        value_function=value_function_enable_disable,
    ...
    SolaXModbusSwitchEntityDescription(
        ...
        register=0xE1,
        sensor_key="battery_to_ev_charger",
        value_function=value_function_enable_disable,
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        allowedtypes=AC | HYBRID | GEN4 | GEN5 | GEN6,
    ...
    SolaXModbusSwitchEntityDescription(
        ...
        register=0xF4,
        sensor_key="vpp_exit_idle_enable",
        value_function=value_function_enable_disable,
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        allowedtypes=AC | HYBRID | GEN4 | GEN5 | GEN6,
    ...
    SolaXModbusSwitchEntityDescription(
        ...
        register=0xF5,
        sensor_key="fast_ct_check_enable",
        value_function=value_function_enable_disable,
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        allowedtypes=AC | HYBRID | GEN4 | GEN5 | GEN6,
    ...
    SolaXModbusSwitchEntityDescription(
        ...
        register=0xB6,
        device_group="dry_contact",
        active_when={"dry_contact_mode": ("Load Management",), "work_mode": ("Manual Mode",)},
        sensor_key="manual_mode_control",
        value_function=value_function_enable_disable,
        allowedtypes=AC | HYBRID | GEN4,
        icon="mdi:dip-switch",
    ),
    SolaXModbusSwitchEntityDescription(
        ...
        register=0x9E,
        sensor_key="phase_power_balance_x3",
        value_function=value_function_enable_disable,
        entity_category=EntityCategory.CONFIG,
    ...
    SolaXModbusSwitchEntityDescription(
        ...
        register=0xC4,
        sensor_key="selfuse_mode_backup",
        value_function=value_function_enable_disable,
        allowedtypes=AC | HYBRID | GEN4 | GEN5,
        icon="mdi:dip-switch",
    ),
...
SELECT_TYPES: Sequence["SolaxModbusSelectEntityDescription"] = [
    ...
    SolaxModbusSelectEntityDescription(
        ...
        register=0xC2,
        device_group="dry_contact",
        active_when={"dry_contact_mode": ("Load Management",)},
        option_dict={
            0: "Disabled",
            1: "Manual Mode",
            2: "Smart Save",
    ...
    SolaxModbusSelectEntityDescription(
        ...
        option_dict={
            ...
            2: "Enable Electric Quantity Target Control Mode",
    ...
    SolaxModbusSelectEntityDescription(
        name="Remote Control Target Set Type (mode 8/9; direct)",
    ...
    SolaxModbusSelectEntityDescription(
        name="Over Frequency Curve Type",
        key="over_frequency_curve_type",
        device_group="settings",
        register=0x620,
        option_dict={
            1: "Type 1",
    ...
    SolaxModbusSelectEntityDescription(
        name="Under Frequency Curve Type",
        key="under_frequency_curve_type",
        device_group="settings",
        register=0x623,
        option_dict={
            1: "Type 1",
...
SENSOR_TYPES_MAIN: list[SolaXModbusSensorEntityDescription] = [
    ...
    SolaXModbusSensorEntityDescription(
        name="Max PV Output Power",
        key="max_pv_output_power",
        native_unit_of_measurement=UnitOfPower.WATT,
    ...
    SolaXModbusSensorEntityDescription(
        key="work_mode",
        register=0x12E,
        scale={0: "Disabled", 1: "Manual Mode", 2: "Smart Save"},
        allowedtypes=AC | HYBRID | GEN4,
        internal=True,
    ),
    SolaXModbusSensorEntityDescription(
    ...
    SolaXModbusSensorEntityDescription(
        ...
        scale={
            ...
            6: "Self-Consume - Charge/Discharge Mode",
            7: "Self-Consume - Charge Only Mode",
            8: "PV and BAT Individual Setting - Duration Mode",
            9: "PV and BAT Individual Setting - Target SOC Mode",
        },
        allowedtypes=AC | HYBRID | GEN4 | GEN5 | GEN6,
        modbus_min=100,
        entity_registry_enabled_default=False,
    ...
    SolaXModbusSensorEntityDescription(
        ...
        register_type=REG_HOLDING,
        scale={
            0xA0: "Exit current VPP mode and switch to user work mode",
            0xA1: "Exit current VPP mode and switch to VPP mode 6",
        },
        allowedtypes=AC | HYBRID | GEN4 | GEN5 | GEN6,
        modbus_min=100,
        entity_registry_enabled_default=False,
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 1 Charge Max Current Readback",
        key="dual_battery_1_charge_max_current_readback",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 2 Charge Max Current Readback",
        key="dual_battery_2_charge_max_current_readback",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        register=0x403,
        register_type=REG_HOLDING,
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 1 Discharge Max Current Readback",
        key="dual_battery_1_discharge_max_current_readback",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        register=0x404,
        register_type=REG_HOLDING,
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 2 Discharge Max Current Readback",
        key="dual_battery_2_discharge_max_current_readback",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        register=0x405,
        register_type=REG_HOLDING,
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 1 Expansion Readback",
        key="dual_battery_1_expansion_readback",
        register=0x406,
        register_type=REG_HOLDING,
        scale=value_function_disabled_enabled,
        allowedtypes=HYBRID | GEN5 | GEN6,
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 2 Expansion Readback",
        key="dual_battery_2_expansion_readback",
        register=0x407,
        register_type=REG_HOLDING,
        scale=value_function_disabled_enabled,
        allowedtypes=HYBRID | GEN5 | GEN6,
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 1 Heating Enable Readback",
        key="dual_battery_1_heating_enable_readback",
        register=0x408,
        register_type=REG_HOLDING,
        scale=value_function_disabled_enabled,
        allowedtypes=HYBRID | GEN5 | GEN6,
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 2 Heating Enable Readback",
        key="dual_battery_2_heating_enable_readback",
        register=0x409,
        register_type=REG_HOLDING,
        scale=value_function_disabled_enabled,
        allowedtypes=HYBRID | GEN5 | GEN6,
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 1 Heating Level Readback",
        key="dual_battery_1_heating_level_readback",
        register=0x40A,
        register_type=REG_HOLDING,
        scale={
            0: "Low",
    ...
    SolaXModbusSensorEntityDescription(
        name="Dual Battery 2 Heating Level Readback",
        key="dual_battery_2_heating_level_readback",
        register=0x40B,
        register_type=REG_HOLDING,
        scale={
            0: "Low",
    ...
    SolaXModbusSensorEntityDescription(
        name="Battery System Installed Capacity",
        key="battery_system_installed_capacity",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        register=0x3A,
        register_type=REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        ...
        scale=0.01,
        rounding=2,
        allowedtypes=AC | HYBRID | GEN3 | GEN4 | GEN5 | GEN6 | EPS,
    ),
    SolaXModbusSensorEntityDescription(
    ...
    SolaXModbusSensorEntityDescription(
        name="EV Charger Communication State",
        key="ev_charger_communication_state",
        register=0xA0,
        register_type=REG_INPUT,
        scale={
            0: "Disconnected",
    ...
    SolaXModbusSensorEntityDescription(
        name="Adapter Box Communication State",
        key="adapt_box_communication_state",
        register=0xA1,
        register_type=REG_INPUT,
        scale={
            0: "Disconnected",
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Reactive Power Total",
        key="grid_reactive_power_total",
        native_unit_of_measurement=UnitOfReactivePower.VOLT_AMPERE_REACTIVE,
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Current Total",
        key="grid_current_total",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        register=0xCD,
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Voltage Start Upper",
        key="grid_voltage_start_upper",
        device_group="settings",
        register=0x32E,
        scale=0.1,
        rounding=1,
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Voltage Start Lower",
        key="grid_voltage_start_lower",
        device_group="settings",
        register=0x32F,
        scale=0.1,
        rounding=1,
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Voltage Over Recover",
        key="grid_voltage_over_recover",
        device_group="settings",
        register=0x330,
        scale=0.1,
        rounding=1,
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Voltage Under Recover",
        key="grid_voltage_under_recover",
        device_group="settings",
        register=0x331,
        scale=0.1,
        rounding=1,
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Frequency Start Upper",
        key="grid_frequency_start_upper",
        device_group="settings",
        register=0x33A,
        scale=0.01,
        rounding=2,
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Frequency Start Lower",
        key="grid_frequency_start_lower",
        device_group="settings",
        register=0x33B,
        scale=0.01,
        rounding=2,
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Frequency Over Recover",
        key="grid_frequency_over_recover",
        device_group="settings",
        register=0x33C,
        scale=0.01,
        rounding=2,
    ...
    SolaXModbusSensorEntityDescription(
        name="Grid Frequency Under Recover",
        key="grid_frequency_under_recover",
        device_group="settings",
        register=0x33D,
        scale=0.01,
        rounding=2,
    ...
    SolaXModbusSensorEntityDescription(
        name="Connection Gradient",
        key="connection_gradient",
        device_group="settings",
        register=0x360,
        scale=0.1,
        rounding=1,
    ...
    SolaXModbusSensorEntityDescription(
        name="Arc Software Version",
        key="arc_software_version",
        device_group="settings",
        register=0x380,
        entity_category=EntityCategory.DIAGNOSTIC,
        allowedtypes=MIC | GEN2 | X3,
    ...
    SolaXModbusSensorEntityDescription(
        ...
        internal=True,
        newblock=True,  # this one fails on some mics #1491 @mapotn
...
TIME_TYPES = [
    ...
    SolaXModbusTimeEntityDescription(
        name="Work Time P1 Stop",
        key="work_end_time_1",
        register=0xBF,
        device_group="dry_contact",
        active_when={"dry_contact_mode": ("Load Management",), "work_mode": ("Smart Save",), "schedule": (1,)},
        option_dict=TIME_OPTIONS_GEN4,
        allowedtypes=AC | HYBRID | GEN4,
        entity_category=EntityCategory.CONFIG,
        icon="mdi:home-clock",
...
class solax_plugin(plugin_base):
    ...
    async def async_determineInverterType(self, hub: Any, configdict: dict[str, Any]) -> int:
        ...
        elif seriesnumber.startswith("XM2"):
            invertertype = MIC | GEN2 | X1  # X1-Mini G3 #2153
            self.inverter_model = "X1-Mini"
